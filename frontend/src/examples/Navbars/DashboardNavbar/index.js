...
function DashboardNavbar({ absolute, light, isMini }) {
  ...
  >
    {notifications.length > 0 ? [
      // MAP DE NOTIFICACIONES (Ahora dentro de un array, sin Fragmento)
      ...
      // DIVIDER Y BOTÓN DE LIMPIAR (Como elementos del array)
      <Divider key="divider" sx={{ my: 1 }} />,
      <MenuItem key="clear-btn" onClick={handleClearNotifications} sx={{ justifyContent: "center" }}>
